...
@section('content')
    ...
    <div class="jumbotron bg-light" data-aos="zoom-in">
    ...
    <div class="jumbotron bg-light" data-aos="zoom-in">
        <h3 class="display-3 text-danger" data-aos="slide-right">Our Team</h3>
        <hr class="my-4">
        <div class="row">
            <div class="col-sm" data-aos="fade-in">
                <div class="display-6 text-danger director-info" style="color: #1a1a1a; font-family: Maven Pro; font-size: 25px;">
                    <img class="rounded w-50  h-70" src="images/director-4.jpg" alt="" data-aos="flip-up">
                    <h3>Director Name</h3>
            ...
            <div class="col-sm" data-aos="fade-in">
                <div class="display-6 text-danger director-info" style="color: #1a1a1a; font-family: Maven Pro; font-size: 25px;">
                    <img class="rounded w-50  h-70" src="images/director-6.jpg" alt="" data-aos="flip-up">
                    <h3>Director Name</h3>
                    <p class="lead text-dark">Brief description of director role</p>
                </div>
            </div>
            <div class="col-sm" data-aos="fade-in">
                <div class="display-6 text-danger director-info" style="color: #1a1a1a; font-family: Maven Pro; font-size: 25px;">
                    <img class="rounded w-50  h-70" src="images/director-3.jpg" alt="" data-aos="flip-up">
                    <h3>Director Name</h3>
                    <p class="lead text-dark">Brief description of director role</p>
                </div>
            </div>
